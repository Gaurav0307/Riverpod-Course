...
import 'package:riverpod_notifier_provider/pages/enum_activity/enum_activity_provider.dart';
...
class _EnumActivityPageState extends ConsumerState<EnumActivityPage> {
  ...
  void fetchActivity() {
    ...
    ref.read(enumActivityProvider.notifier).getActivities(activityTypes[index]);
  }

  @override
  Widget build(BuildContext context) {
    final enumActivityState = ref.watch(enumActivityProvider);
