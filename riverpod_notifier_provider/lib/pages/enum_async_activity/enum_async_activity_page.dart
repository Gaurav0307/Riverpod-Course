...
import 'package:riverpod_notifier_provider/pages/enum_async_activity/enum_async_activity_provider.dart';
import 'package:riverpod_notifier_provider/pages/enum_async_activity/enum_async_activity_state.dart';

class EnumAsyncActivityPage extends ConsumerStatefulWidget {
  const EnumAsyncActivityPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EnumAsyncActivityPageState();
}

class _EnumAsyncActivityPageState extends ConsumerState<EnumAsyncActivityPage> {
  @override
  Widget build(BuildContext context) {
    final enumActivityState = ref.watch(enumAsyncActivityProvider);
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Enum Async Activity'),
        actions: [
          IconButton(
      ...
      body: switch (enumActivityState.status) {
        ActivityStatus.loading => Center(
          child: const CircularProgressIndicator(),
        ),
        ActivityStatus.success => ActivityCard(
          activity: enumActivityState.activity,
        ),
        ActivityStatus.failure =>
          enumActivityState.activity == Activity.empty()
              ? Center(
                  child: const Text(
                    "Get some activity",
              ...
              : ActivityCard(activity: enumActivityState.activity),
      },
