...
import 'package:riverpod_asyncvalue_details/pages/weather_first/weather_first_provider.dart';
...
class WeatherFirstPage extends ConsumerWidget {
  ...
  OutlinedButton getWeatherButton(WidgetRef ref) {
    return OutlinedButton(
      onPressed: () async {
        ref
            .read(weatherFirstProvider.notifier)
            .getTemperature(Cities.values[_selectedCityIndex]);
